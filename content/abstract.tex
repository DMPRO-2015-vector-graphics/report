...
The system is implemented on a Xilinx FPGA, that produces and processes vector graphics.
...
The system produces an analogue two-coordinate output that can be shown on any display support X,Y input.
