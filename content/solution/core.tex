...
As opposed to the MIPS architecture, they cant all be grouped into categories based on their format.
...
The remaining bits are used either to address registers, to encode immediate values or a combination.
